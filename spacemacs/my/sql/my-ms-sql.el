...
(eval-after-load "sql"
  '(progn
     ...
     (define-key sql-mode-map "\e1;3P" 'write-ms-desc-sql-region-to-buffer) ;Alt + F1
     (define-key sql-mode-map "\e1;3Q" 'write-ms-script-sql-region-to-buffer) ;Alt + F2
     (define-key sql-mode-map "\e1;3R" 'insert-script) ;Alt + F3
     (define-key sql-mode-map "\e15;3~" 'write-ms-sql-result-to-buffer) ;Alt + F5
     (define-key sql-mode-map "\e17;3~" 'write-ms-select-sql-region-to-buffer) ;Alt + F6
     (define-key sql-mode-map "\e18;3~" 'write-ms-get-columns) ;Alt + F7
     ...
     (define-key sql-mode-map "\e24;9~" 'create-sql-region-and-write-to-buffer) ;Ctrl + Return
   )
)
