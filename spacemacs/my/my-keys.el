...
(define-key evil-hybrid-state-map (kbd "C-y") 'undo-tree-redo)
...
(define-key evil-hybrid-state-map (kbd "TAB") 'indent-block)
(define-key evil-insert-state-map [(backtab)] 'unindent-block)
(define-key evil-hybrid-state-map [(backtab)] 'unindent-block)
(define-key evil-insert-state-map (kbd "C-SPC") 'company-complete)
(define-key evil-hybrid-state-map (kbd "C-SPC") 'company-complete)
(define-key evil-insert-state-map (kbd "C-@") 'company-complete)
(define-key evil-hybrid-state-map (kbd "C-@") 'company-complete)
(define-key evil-insert-state-map (kbd "C-M-SPC") 'yas-expand)
(define-key evil-hybrid-state-map (kbd "C-M-SPC") 'yas-expand)
...
(define-key evil-hybrid-state-map (kbd "M-<left>") 'evil-jump-backward)
...
(define-key evil-hybrid-state-map (kbd "M-<right>") 'evil-jump-forward)
