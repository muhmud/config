...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; (default "%I@%S")
   dotspacemacs-frame-title-format "%I - %b [%m]"
...
(custom-set-variables
 ...
 '(lsp-java-format-settings-url
   "file:///home/muhmud/.my-emacs.d/eclipse-java-google-style.xml")
